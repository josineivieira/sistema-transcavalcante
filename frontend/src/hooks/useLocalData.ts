...
import type { AppData, Closing, ContainerRecord, Customer, Driver, FiscalDocument, Freight, PayrollClosing, PriceList, Receivable, SystemUser, Vehicle } from '../services/localStore'
