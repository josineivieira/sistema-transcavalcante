  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<AppLayout />}>
        ...
        <Route path="purchase-requests" element={<ProtectedPage path="/purchase-requests"><PurchaseRequestsPage /></ProtectedPage>} />
        <Route path="payroll" element={<ProtectedPage path="/payroll"><PayrollPage /></ProtectedPage>} />
